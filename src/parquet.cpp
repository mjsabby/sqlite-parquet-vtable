 ...
 * in this file. */
static int parquetCreate(sqlite3 *, void *, int, const char *const *, sqlite3_vtab **, char **);
static int parquetConnect(sqlite3 *, void *, int, const char *const *, sqlite3_vtab **, char **);
...
static int parquetFilter(sqlite3_vtab_cursor *, int idxNum, const char *idxStr, int argc, sqlite3_value **argv);
...
static int parquetOpen(sqlite3_vtab *p, sqlite3_vtab_cursor **ppCursor)
{
    try
    {
        std::unique_ptr<sqlite3_vtab_cursor_parquet, void (*)(void *)> cursor(
            (sqlite3_vtab_cursor_parquet *)sqlite3_malloc(sizeof(sqlite3_vtab_cursor_parquet)), sqlite3_free);
...
*/
static int parquetColumn(sqlite3_vtab_cursor *cur, /* The cursor */
        ...
        else
        {
            ...
            default:
                ...
                ss << __FILE__ << ":" << __LINE__ << ": column " << col
                   << " has unsupported type: " << parquet::TypeToString(cursor->getPhysicalType(col));
...
** the beginning.
*/
static int parquetFilter(sqlite3_vtab_cursor *cur, int idxNum, const char *idxStr, int argc, sqlite3_value **argv)
{
    try
    {
        sqlite3_vtab_cursor_parquet *vtab_cursor_parquet = (sqlite3_vtab_cursor_parquet *)cur;
